...
function ENT:Draw()
	...
	if LocalPlayer():GetPos():Distance(self:GetPos()) < EML_DrawDistance then
		...
		cam.Start3D2D(pos + ang:Up()*6.9, ang, 0.055)
			draw.SimpleTextOutlined("Iodine", "methFont", 0, -128, Color(220, 134, 159, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(25, 25, 25, 100));
			...
			draw.SimpleTextOutlined("Contents", "methFont", -44, -62, Color(220, 134, 159, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER, 1, Color(25, 25, 25, 100));
		...
		cam.Start3D2D(pos + ang:Up()*7, ang, 0.045)		
			draw.SimpleTextOutlined("Muriatic Acid ("..self:GetNWInt("macid")..")", "methFont", -121, -40, macidColor, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER, 1, Color(25, 25, 25, 100));
			draw.SimpleTextOutlined("Liquid Iodine ("..self:GetNWInt("iodine")..")", "methFont", -121, -10, iodineColor, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER, 1, Color(25, 25, 25, 100));	
			draw.SimpleTextOutlined("Water ("..self:GetNWInt("water")..")", "methFont", -121, 20, waterColor, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER, 1, Color(25, 25, 25, 100));			
		cam.End3D2D();			
